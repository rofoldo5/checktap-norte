          ...
          children: <Widget>[
            ...
            if (_task.checklists.isEmpty)
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    if (canWork && _task.status != 'COMPLETADA') ...<Widget>[
                      const SizedBox(height: CheckTapSpacing.md),
                      FilledButton.icon(
              ...
              ..._task.checklists.map(
                (checklist) => Padding(
                  padding: const EdgeInsets.only(bottom: CheckTapSpacing.md),
                  child: TaskChecklistCard(
                    checklist: checklist,
                    enabled: canWork && _task.status != 'COMPLETADA' && !_busy,
                    ...
                    onEditItem: (item) => _editChecklistItem(checklist, item),
                    onDeleteItem: (item) =>
            ...
            if (_task.checklists.isNotEmpty &&
                _task.checklists.every((checklist) => checklist.isCompleted) &&
              ...
              Container(
                ...
                child: const Row(
                  children: <Widget>[
                    Icon(Icons.verified_rounded, color: CheckTapColors.success),
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            if (task.status == 'PENDIENTE' && canWork) ...<Widget>[
              Expanded(
