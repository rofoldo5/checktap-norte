...
El registro y el primer inicio de sesión aprobado requieren acceso al servidor. Después de la primera sincronización, CheckTap conserva la sesión y los datos necesarios en el dispositivo.
...
| `SELF_REGISTRATION_ENABLED` | Habilita o deshabilita el autorregistro de colaboradores |
